...
for i_N=1:N
    sim('replay_attack_encoding.slx');
    i_N
    k1 = 100;
    k2 = 350;
...
x = [150 250 250 150];
y = [-1 -1 1.1 1.1];
patch(x,y,'green','FaceAlpha',.25,'EdgeColor','none')
xlabel('Time[sec]')
ylabel('Likelihood')
hold on
x = [250 350 350 250];
...
legend(['$f(\hat{v}_k,\mu,\Sigma)$'],['$\zeta$'],['{recoding phase}'],['replaying phase'],'interpreter','latex')